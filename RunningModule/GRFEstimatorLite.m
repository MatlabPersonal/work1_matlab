function [GRF_Left, GRF_Vector_Left,GRF_Right, GRF_Vector_Right] = ...
    GRFEstimatorLite(time1,acc_left1,acc_right1,highg_left,highg_right,BodyMass)
% acc_left1 = double(acc_left(454026:466315));
% acc_right1 = double(acc_right(454026:466315));
% time1 = time(454026:466315) - time(454026);
% BodyMass=80;
...
[GRF_Left, GRF_Vector_Left, IPA_Left, IPA_Vector_Left, ...
    ...
    dataFilt_Left, troughsSpeed_Left, dataFilt_Right, troughsSpeed_Right,highg_left,highg_right);

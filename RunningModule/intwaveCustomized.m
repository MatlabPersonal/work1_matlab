function [out1,xval] = intwaveCustomized(wname,in2)
...
% wtype = 1;
[~,psi,xval] = wavefunCustomized(wname,iter);
% switch wtype
%   case {1,3} , [phi,psi,xval] = wavefunCustomized(wname,iter);
%   case 2     , [phi1,psi1,phi2,psi2,xval] = wavefunCustomized(wname,iter);
%   case {4,5} , [psi,xval] = wavefunCustomized(wname,iter);
%   case 4 || 5 , [psi,xval] = wavefunCustomized(wname,iter);
% end

step = xval(2)-xval(1);
out1 = cumsum(psi)*step;
% switch wtype

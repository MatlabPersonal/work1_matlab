...
function [EulerS1, EulerS2, EulerS3,...
          ...
          EulerUpperS1, EulerUpperS2, EulerUpperS3] = processData_vhv2_prone_xzy(accX1,accY1,accZ1,accX2,accY2,accZ2,...
...
acc_tx1=asin(acc1(:,1)./mag_acc_low);
...
acc_tx2=asin(-acc2(:,1)./mag_acc_upp);

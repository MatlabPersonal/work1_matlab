function [y,L]= upsconv1Customized(x,f,s,dwtARG1,dwtARG2)
...
y = x;
if ~perFLAG
    y = wconv1Customized(dyadupCustomized(y,0),f);
    y = wkeep1Customized(y,s);
else
    y = dyadupCustomized(y,0,1);
    y = wextendCustomized('1D','per',y,lf/2);    
    y = wconv1Customized(y,f);
    y = y(lf:lf+s-1);

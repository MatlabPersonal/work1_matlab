...
function [EulerS1, EulerS2, EulerS3,...
          ...
          EulerUpperS1, EulerUpperS2, EulerUpperS3] = processData_vhv2(accX1,accY1,accZ1,accX2,accY2,accZ2,...
...
acc_fx1=atan2(-acc1(:,2),acc1(:,3));
acc_lf1=asin(-acc1(:,1)./mag_acc_low);
q_vm1=quatint(angle2quat(mean(acc_fx1(1:5)),mean(acc_lf1(1:5)),0,'xyz'),gyr1,T);
q_vm1_a=angle2quat(acc_fx1,acc_lf1,zeros(length(accX1),1),'xyz');
acc_fx2=atan2(-acc2(:,2),-acc2(:,3));
acc_lf2=asin(acc2(:,1)./mag_acc_upp);
q_vm2=quatint(angle2quat(-mean(acc_fx2(1:5)),mean(acc_lf2(1:5)),0,'xyz'),gyr2,T);

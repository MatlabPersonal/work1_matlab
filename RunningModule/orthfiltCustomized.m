%function [Lo_D,Hi_D,Lo_R,Hi_R] = orthfiltCustomized(W,P)
function [Lo_D,Hi_D,Lo_R,Hi_R] = orthfiltCustomized(W)
...
% Associated filters.
Lo_R = sqrt(2)*W;
Hi_R = qmfCustomized(Lo_R);
Hi_D = wrevCustomized(Hi_R);
Lo_D = wrevCustomized(Lo_R);

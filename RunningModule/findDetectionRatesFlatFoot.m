%% FlatFoot
% Remove wrong peaks
% clear temp_left ; temp_left = FlatFoot_Left;
% 
% % Left
% cursors_left=[];
...
% end
% FlatFoot_Left=temp_left;
% 
% %% Right
% clear temp_right; temp_right = FlatFoot_Right;
% cursors_right=[];
...
cursors_left=round(sort(cursors_left));
FlatFoot_Left = [FlatFoot_Left cursors_left];
...
cursors_right=round(sort(cursors_right));
FlatFoot_Right = [FlatFoot_Right cursors_right];